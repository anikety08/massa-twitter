...
export function RetweetIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GifIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <text x="5" y="15" fontSize="8" fill="currentColor" stroke="none" fontWeight="bold">GIF</text>
    </svg>
  );
}

export function EmojiIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FollowIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HashtagIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookmarkIcon({ size = 24, filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LogoIcon({ size = 32, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <text x="16" y="21" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">M</text>
    </svg>
  );
}
